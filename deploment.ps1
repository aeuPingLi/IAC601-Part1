...
new-PSDrive -Name "DS001" -PSProvider "MDTProvider" -Root "C:\DeploymentShare" -Description "MDT Deployment Share" -NetworkPath "\\ServerPingLi\DeploymentShare" -Verbose | add-MDTPersistentDrive -Verbose
...
import-mdttasksequence -path "DS001:\Task Sequences" -Name "win11" -Template "Client.xml" -Comments "Deploying Windows 11" -ID "1" -Version "1.0" -OperatingSystemPath "DS001:\Operating Systems\Windows 11 Pro in Windows 11 install.wim" -FullName "Windows User" -OrgName "Ping" -HomePage "about:blank" -Verbose
$CSFile = @"
[Settings]
...
[Default]
DeployRoot=\\ServerPingLi\DeploymentShare
UserID=Administrator
UserPassword=Philicia*588
UserDomain=ping.com
SkipBDDWelcome=YES
TaskSequenceID=1
